...
func cmdDelegationsGenerate(envID, keyPath string, size, expiration int, importKey bool, ie environments.IEnvironments, ii images.IImages, ip prompts.IPrompts) error {
